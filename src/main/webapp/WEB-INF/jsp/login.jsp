        ...
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form method="post" class="layui-form"  action="">
                <div class="panel loginbox">
                    <div class="text-center margin-big padding-big-top"><h1>社区管理系统</h1></div>
            ...
            <div style="padding:10px;"><button  class="button button-block bg-main text-big " id="login_btn"  ><span style="color: #ffffff">登录</span></button></div>
            <script>
                var BASE_URL ="http://localhost:8081/";
                $(function () {
                    //登录
                    var  URL = "${pageContext.request.contextPath}/doLogin";
