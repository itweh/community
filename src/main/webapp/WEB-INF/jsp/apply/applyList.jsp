...
<head>
    ...
    <title>社区申请出入列表</title>
    <link rel="stylesheet" href="/static/css/pintuer.css">
    <link rel="stylesheet" href="/static/css/admin.css">
</head>
<body>
<form method="post" action="${pageContext.request.contextPath}/apply/list" id="listform" >
    <div class="panel admin-panel">
        <div class="panel-head"><strong class="icon-reorder"> 申请列表</strong>
        </div>
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li><a class="button border-main icon-plus-square-o" href="${pageContext.request.contextPath}/apply/openApply">出入申请</a></li>
                <li>搜索：</li>
                <li>
        ...
        <table class="table table-hover text-center">
            ...
            <c:forEach items="${applyList}" var="data">
                <tr>
                    ...
                    <td>
                <div class="button-group"><a class="button border-main"  href="/apply/openEdit?id=${data.id}"><span
                        class="icon-edit"></span> 修改</a>
                    <a class="button border-main"  href="/apply/submit?id=${data.id}"><span
                            class="icon-save"></span> 提交审核</a>
                    <a class="button border-red" href="${pageContext.request.contextPath}/apply/delete?id=${data.id}"><span
