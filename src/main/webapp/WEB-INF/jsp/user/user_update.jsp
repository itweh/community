    ...
    <div class="body-content">
        <form method="post" class="form-x" action="#">
            <div class="form-group">
                <input type="hidden" id="id" value="${updateUser.id}">
                <div class="label">
                    <label>用户名：</label>
                </div>
                <div class="field">
                    <input type="text" class="input w50"  value="${updateUser.username}" value=""  id="username" name="username" data-validate="required:必填"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50"  value="${updateUser.realName}" name="realName"  id="realName" data-validate="required:必填"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="password" class="input w50"  value="${updateUser.password}" name="password" id="password" data-validate="required:必填"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="password" class="input w50"   name="password" id="repeatPass" data-validate="required:必填"/>
                    <div class="tips"></div>
                </div>
            </div>
        <%--    <div class="form-group">
    ...
    $(function () {
        ...
        $("#user_edit").click(function () {
            ...
            axios.post(URL,{
                ...
                /*var rediect_url="${pageContext.request.contextPath}/index";*/
